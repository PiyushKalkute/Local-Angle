          ...
          <div class="col-md-4 d-flex ftco-animate">
			  ...
			  <div class="topper d-flex align-items-center">
              		<div class="two pl-0 pr-3 py-2 align-self-stretch" align="right">
              			<span class="mos"><?php $query = "SELECT * from links where LINK IN  (Select link from alumna where NAME IN( SELECT Name FROM geo_tags where BIRTHPLACE = \"$array[$selected_val]\" OR  BIRTHPLACE like \"%$array[$selected_val]%\"))";
                ...
                <h3 class="heading mt-2"><a href="#"><?php $query = "SELECT * from links where LINK IN  (Select link from alumna where NAME IN( SELECT Name FROM geo_tags where BIRTHPLACE = \"$array[$selected_val]\" OR  BIRTHPLACE like \"%$array[$selected_val]%\"))";
							if ($stmt = $conn->prepare($query)) {
								$stmt->execute();
								$stmt->bind_result($link,$title,$published_time);
								while ($stmt->fetch()) {
